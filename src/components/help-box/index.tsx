...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Trading Card Dealer'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Trading Card Dealer', 'Market Analyst', 'App Administrator', 'Community Moderator'];
  const addOns: string[] = ['file'];
  const applicationName = `CardValueScan`;
